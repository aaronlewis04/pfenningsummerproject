...
VlnPlot(NA9, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3) 
NA9plot1 <- FeatureScatter(NA9, feature1 = "nCount_RNA", feature2 = "percent.mt")
...
DimPlot(NA9, reduction = "umap", label = TRUE, pt.size = 0.5) #new UMAP clustering with celltypes
...
DimPlot(NA9, reduction = "umap", label = TRUE, pt.size = 0.5)
