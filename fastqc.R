...
#connected via to the cmu cluster with ssfhs which i downloaded from a github repo following instructions from user @thallgren on this page : https://github.com/telepresenceio/telepresence/issues/1654
